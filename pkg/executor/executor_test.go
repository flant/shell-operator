...
func TestRunAndLogLines(t *testing.T) {
	...
	t.Run("invalid json structure", func(t *testing.T) {
		...
		assert.Equal(t, buf.String(), `{"level":"debug","msg":"Executing command 'echo [\"a\",\"b\",\"c\"]' in '' dir","source":"executor/executor.go:112","a":"b","time":"2006-01-02T15:04:05Z"}`+"\n"+
			`{"level":"debug","msg":"json log line not map[string]interface{}","source":"executor/executor.go:184","a":"b","line":["a","b","c"],"output":"stdout","time":"2006-01-02T15:04:05Z"}`+"\n"+
			`{"level":"info","msg":"[\"a\",\"b\",\"c\"]\n","source":"executor/executor.go:187","a":"b","output":"stdout","time":"2006-01-02T15:04:05Z"}`+"\n")
