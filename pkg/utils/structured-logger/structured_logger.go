...
func NewStructuredLogger(logger *unilogger.Logger, componentLabel string) func(next http.Handler) http.Handler {
...
func (l *StructuredLogger) NewLogEntry(r *http.Request) middleware.LogEntry {
	entry := &StructuredLoggerEntry{Logger: unilogger.NewLogger(unilogger.Options{})}
...
func GetLogEntry(r *http.Request) *unilogger.Logger {
