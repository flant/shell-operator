...
func (op *ShellOperator) handleRunHook(t task.Task, taskHook *hook.Hook, hookMeta task_metadata.HookMetadata, taskLogEntry *unilogger.Logger, hookLogLabels map[string]string, metricLabels map[string]string) error {
