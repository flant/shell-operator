...
func (op *ShellOperator) initHookManager() (err error) {
	...
	if err != nil {
		log.Error("MAIN Fatal: initialize hook manager", log.Err(err))
		return err
	}
...
func (op *ShellOperator) initValidatingWebhookManager() (err error) {
	...
	if err != nil {
		log.Error("ValidatingWebhookManager init", log.Err(err))
		return err
	}
	...
	if err != nil {
		log.Error("ValidatingWebhookManager start", log.Err(err))
	}
	return err
}
...
func (op *ShellOperator) initConversionWebhookManager() (err error) {
	...
	if err != nil {
		log.Error("ConversionWebhookManager init", log.Err(err))
		return err
	}
	...
	if err != nil {
		log.Error("ConversionWebhookManager Start", log.Err(err))
	}
	return err
}
